package com.freezek.engine.domain.customer;

import com.alibaba.cola.domain.Entity;
import com.alibaba.cola.exception.BizException;
import lombok.Data;

import com.freezek.engine.dto.domainmodel.*;

//Domain Entity can choose to extends the domain model which is used for DTO
@Data
@Entity
public class Customer extends com.freezek.engine.dto.domainmodel.Customer{
